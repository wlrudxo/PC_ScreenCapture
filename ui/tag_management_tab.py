...
class TagManagementTab(QWidget):
    """
    태그 관리 탭
    - 태그 관리 (추가/수정/삭제)
    - 룰 관리 (추가/수정/삭제/우선순위)
    ...
    def load_tags(self):
        ...
        try:
            ...
            print(f"[TagManagementTab] 태그 로드 오류: {e}")
    ...
    def add_tag(self):
        ...
        if dialog.exec() == QDialog.DialogCode.Accepted:
            ...
            try:
                ...
                self.load_tags()
                print(f"[TagManagementTab] 태그 추가됨: {data['name']}")
            except Exception as e:
    ...
    def edit_tag(self):
        ...
        if dialog.exec() == QDialog.DialogCode.Accepted:
            ...
            try:
                ...
                self.load_tags()
                print(f"[TagManagementTab] 태그 수정됨: {data['name']}")
            except Exception as e:
    ...
    def delete_tag(self):
        ...
        try:
            ...
            if reply == QMessageBox.StandardButton.Yes:
                ...
                self.load_tags()
                self.load_rules()
                print(f"[TagManagementTab] 태그 삭제됨: {tag_data['name']}")
        except Exception as e:
    ...
    def load_rules(self):
        ...
        try:
            ...
            print(f"[TagManagementTab] 룰 로드 오류: {e}")
    ...
    def add_rule(self):
        ...
        if dialog.exec() == QDialog.DialogCode.Accepted:
            ...
            try:
                ...
                self.load_rules()
                print(f"[TagManagementTab] 룰 추가됨: {rule_data['name']}")
            except Exception as e:
    ...
    def edit_rule(self):
        ...
        if dialog.exec() == QDialog.DialogCode.Accepted:
            ...
            try:
                ...
                self.rule_engine.reload_rules()  # 룰 엔진 갱신!
                self.load_rules()
                print(f"[TagManagementTab] 룰 수정됨: {updated_data['name']}")
            except Exception as e:
    ...
    def delete_rule(self):
        ...
        if reply == QMessageBox.StandardButton.Yes:
            try:
                ...
                self.rule_engine.reload_rules()  # 룰 엔진 갱신!
                self.load_rules()
                print(f"[TagManagementTab] 룰 삭제됨: {rule_data['name']}")
            except Exception as e:
